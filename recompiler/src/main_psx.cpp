...
int main(int argc, char** argv) {
    ...
    std::vector<PSXRecompV4::WidescreenCullEdgeSite> ws_cull_edge;
    ...
    if (!config_path.empty()) {
        ...
        ws_cull_edge = cfg.ws_cull_edge_sites;
    ...
    if (!ws_config_path.empty()) {
        ...
        if (ws_cull_edge.empty()) ws_cull_edge = wscfg.ws_cull_edge_sites;
    ...
    codegen_config.ws_cull_edge_sites = ws_cull_edge;
